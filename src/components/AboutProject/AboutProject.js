        ...
        <Layout className="aboutProject global-padding">
            ...
            <div className="content">
                ...
                <div className="row">
                    ...
                    <div className="content-text">
                            <p><span className="chapter">Наталка Федечко</span></p>
                            <span className="highlight">Співзасновниця та координаторка Ініціативи “Навчай українською”</span>
                            <br></br>
                            Активна учасниця групи захисту мовного закону і права україномовних на послуги
                            українською мовою в Україні. Ініціювала розпорядження департаменту культури КМДА
                            про викладання у мистецьких школах Києва українською мовою. Експертка з комунікацій
                            та менеджерка соціальних, освітніх та культурних проєктів. Конкретніше:
                            консультантка з розробки та створення телевізійного шоу про нові об’єднані
                            територіальні громади, головний редактор програми журналістських розслідувань
                            «Брат за брата», редактор розважальних програм Новий канал, впродовж десяти років
                            журналістка та ведуча програми новин «Репортер» Новий канал. Хочу дізнатись, що
                            зміниться, якщо в Україні всі розмовлятимуть українською? Чи змінить це ставлення
                            громадян до своєї країни? Чи стане молодь більше поважати свій край?
                    </div>
                </div>

                <div className="row">
                        <div className="content-text">
                            <p><span className="chapter">Іванна Кобєлєва</span></p>
                            <span className="highlight">Комунікаційна менеджерка Ініціативи "Навчай українською"</span>
                            <br></br>
                            Комунікаційна менеджерка Ініціативи "Навчай українською". Редакторка волонтерського
                            проєкту Портал мовної політики. Учасниця спільноти "Мова об'єднує", яка займається
                            адвокацією закону "Про забезпечення функціонування української мови як державної".
                            Мріє, щоб ті, хто говорить українською, не почували себе дискримінованими.
                        </div>
