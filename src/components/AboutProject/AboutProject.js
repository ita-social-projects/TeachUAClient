            ...
            <div className="content">
                ...
                <section className="sport-clubs">
                    ...
                    <div className="content-text sport desc">
                        ...
                        інформацію про товари і послуги державною мовою. Громадяни мають право отримати освітній послуги
                ...
                <section className="stars">
                    ...
                    <div className="row">
                        <div className="col">
                            {/*<div className="image">*/}
                            {/*    <img src={`${process.env.PUBLIC_URL}/static/images/service/about_img_1.jpg`}></img>*/}
                            {/*</div>*/}
                        </div>
                        <div className="col info">
                            <div className="text">
                                <span> "Я сьогодні бачу в своїй стрічці багато суму через бар’єри, які доводиться долати,
                                аби виховувати дітей рідною мовою. І дуже вірю, що скоро одним викликом,
                                як то мова позашкільної освіти, стане менше! Повірте, батьки дуже люблять,
                                коли їхніх дітей хтось вчить українською мовою, коли вони мають цю можливість.
                                Попит на те, щоб ви викладали українською мовою, величезний і дуже сильно недооцінений.
                                Думаю, керівники гуртків це відчують, коли почнуть переходити на українську мову”, -
                                сказала ведуча
                                “1+1” Марічка Падалко під час онлайн-зустрічі “Українська історія зірок”.
                                Ця зустріч була стартом першого 21-денного челенджу “Навчай українською” для викладачів
                                дитячих гуртків,
                                    секцій та студій, які переходять на українську мову викладання. </span>
                            </div>
                        </div>
                    </div>
                    <div className="row">
                        <div className="col info">
                            <div className="text">
                                <span>«Я прошу всіх викладачів, хто не байдужий до долі цієї країни і дітей переходити на
                                українську.
                                Бо діти будуть обмежені в своєму розвитку, якщо закон України про мову не буде
                                виконуватися.
                                Не можна жити в Швеції не знаючи шведської мови, не можна жити в ОАЕ не знаючи арабської
                                мови.
                                Можливо раніше можна було жити в Україні і спілкуватись тільки російською, але ті часи
                                давно пройшли.
                                До того ж, слава Богу, ми не росіяни», - закликав освітян викладати дітям українською
                                продюсер і шоумен Ігор Кондратюк. </span>
                            </div>
                        </div>
                        <div className="col">
                            <div className="image">
                                <img src={`${process.env.PUBLIC_URL}/static/images/service/about_img_1.jpg`} alt=""></img>
                            </div>
                        </div>
                    </div>
                    <div className="row">
                        <div className="col">
                            <div className="image">
                                <img src={`${process.env.PUBLIC_URL}/static/images/service/about_img_2.jpg`} alt=""></img>
                            </div>
                        </div>
                        <div className="col info">
                            <div className="text">
                               <span> Лідер гурту "Антитіла" Тарас Тополя закликав освітян викладати дітям українською:
                                «Коли ми говоримо про людину як соціальну істоту, яка кодується – ми маємо думати про
                                те,
                                як буде закодоване майбутнє покоління. І тут мова має визначне значення.
                                Якщо б ми використовували латинку, а не кирилицю нам би було в тисячу разів легше
                                протистояти російській інформаційній війні, яка ведеться проти нас. Звісно, ми не
                                маємо права ображати людей, які користуються російською мовою, але ми маємо право
                                і етичне зобов’язання перед майбутнім поколінням закодувати його на українську мову.
                                Щоб вона стала потрібною і цікавою для нього» </span>
                    ...
                    <div className="row">
                        <div className="col info">
                            <div className="text">
                               <span> Тенісист Сергій Стаховський закликав освітян викладати дітям українською:
                                «З 2014 року я всі свої інтерв’ю даю українською мовою, бо вважаю, що ми миємо
                                нею пишатися. Українська мова є нашою ідентичністю. Мені хотілося б щоб результатом
                                цього челенджу було те, що діти, які займаються гуртках і, в тому числі, спортивних
                                секціях у майбутньому представляли свою країну в світі українською мовою,
                                   бо це майбутні чемпіони». </span>
                            </div>
                        </div>
                        <div className="col">
                            <div className="image">
                                <img src={`${process.env.PUBLIC_URL}/static/images/service/about_img_3.png`} alt=""></img>
                            </div>
                        </div>
                    </div>
                </section>
                <section className="quotes-clubs">
                    <div className="title-content ">
                        ЦИТАТИ ГУРТКІВ
                    </div>
                    <div className="title-content ">
                    ...
                    <div className="content-text">
                        &#127793; Я змогла взяти для себе чимало важливих професійних порад щодо ведення занять рідною
                        мовою,
                        доречного вживання фахової термінології тощо. Дуже сподобалося, що модератори змогли
                        створити легку невимушену атмосферу нашого навчання, що ми могли спілкуватися
                        безпосередньо з нашими професійними наставниками та колегами. Вікторія Оленяк,
                        керівниця ансамблю народного танцю “Дружба”, Центр творчості дітей та юнацтва
                        Олександрівського району Запорізької міськради.
                    </div>
                    <div className="content-text">
                        &#127793; Станції юних техніків №3 міста Харкова висловлює щиру подяку модераторам челенджу
                        "Навчай українською". Ми отримали корисний досвід спілкування українською, поглибили знання з
                        мови та
                        познайомилися з чудовими людьми. Дарина Щипанова, м. Харків.
                    </div>
                    <div className="content-text">
                        &#127793; Дякую організаторам за чудовий челендж! Страху не було, було очікування, які цілком
                    ...
                    <div className="content-text">
                        &#127793; За час челенджу я удосконалина проведення занять українською мовою Почала в чаті
                        писати
                        дітям домашнє завдання українською та спілкуватися з друзями, дивитись мультфільми та фільми,
                        читаю
                        дитячі вірші та казки. Стала впевнено себе почувати: зараз спілкуюсь у супермаркет та аптеці.
                        Переклала професійні терміни, поліпшила знання з правопису. Дякую за плідну працю та надання
                        матеріалів для роботи, за корисні вебінари. Хочу ще. Юлія Матвеєнко, м. Харків, Центр
                        позашкільної
                        освіти "Мрія".
                    </div>
                </section>
