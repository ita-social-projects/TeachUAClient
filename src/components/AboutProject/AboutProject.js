        ...
        <Layout className="aboutProject global-padding">
            ...
            <div className="content">
                        ...
                        <div className="col info">
                            <div className="text">
                                ...
                                <span>
                                    ...
                                    «З 2014 року я всі свої інтерв’ю даю українською мовою, бо вважаю, що ми миємо нею пишатися.
                                    Українська мова є нашою ідентичністю. Мені хотілося б щоб результатом цього челенджу було те,
                                    що діти, які займаються гуртках і, в тому числі, спортивних секціях  у майбутньому  представляли
                ...
                <section className="quote-clubs">
                    ...
                    <div className="content-text">
                        &#127793; Дякую організаторам за чудовий челендж! Страху не було, було очікування, які цілком виправдались.
                    ...
                    <div className="content-text">
                        &#127793; За час челенджу я удосконалина проведення занять українською мовою Почала в чаті писати дітям
                        домашнє завдання українською та спілкуватися з друзями, дивитись мультфільми та фільми,
                        читаю дитячі вірші та казки. Стала впевнено себе почувати: зараз спілкуюсь у супермаркет та аптеці.
