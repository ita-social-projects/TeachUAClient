    ...
    return (
        <Layout className="global-padding">
            ...
            <MainChallenge
                ...
                text='Ми разом з вами хочемо, щоб молоде покоління добре знало українську мову, і розуміємо, 
...
// Близько тисячі учасників з усієї України уже взяли участь у 21-денному челенджі
