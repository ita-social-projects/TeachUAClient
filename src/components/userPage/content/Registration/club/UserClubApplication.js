...
const UserClubApplication = ({ application, cancelApplication }) => {
    ...
    const panelHeader = application.child
        ? (
            <div className={labelClass}>
                ...
                <span className={classes.typeName}>{application.club.name}</span>
                <Button
        ...
        : (
            <div className={labelClass}>
                ...
                </div>                <span className={classes.typeName}>{application.club.name}</span>
                <Button
                    className={classes.cancelButton}
                    onClick={(event) => {
                        event.stopPropagation();
...
export default UserClubApplication;