...
`,
      text2: `Ми розуміємо, що іноді психологічно незручно переходити на українську зі знайомими, бо 
      хочеться уникнути запитань на тему мови. Порада від Олександра Жугана, викладача 
      акторської майстерності, який перейшов на українську п’ять років тому під час подібного 
      марафону до Дня Незалежності:

      «Коли мене запитували, що сталося і чому почав говорити українською, я казав своїм 
      друзям і учням, що беру участь у Мовомарафоні до річниці Незалежності. Питань більше не 
      виникало».

       Олександр Медведєв, викладач комп’ютерної графіки та дизайну, який взяв участь у 
       першому челенджі «Навчай українською», поділився своїм досвідом:
      «Часто перепоною стає сором’язливість: адже ось учора ми з учнями спілкувалися 
      російською, а сьогодні я раптом став україномовним. Як вони це сприймуть? Чи не 
      піднімуть на кпини? Чи не захочуть піти від мене через незручність спілкування? Як це 
      сприймуть батьки учнів, колеги на роботі? Не треба вдавати, що нічого не сталося. Варто 
      чесно сказати всім: відтепер я розмовляю українською, це моя позиція. Обґрунтована 
      позиція. І від такого вчинку отримуємо декілька вигод: 1) оголошена позиція стимулюватиме 
      вас триматися свого слова, не дасть відступитися; 2) ваша відповідь або лекція українською 
      мовою не стане несподіванкою для учнів, інших людей; 3) ви змусите якийсь відсоток учнів 
      перейти на українську мову, принаймні з вами; 4) ви дасте поштовх іншим людям навколо 
      — учням, колегам, батькам учнів — замислитися над власною мовою спілкування. А 
      можливо, виявиться,  що ви не один такий. Що люди навколо теж давно прагнули 
      спілкуватися нашою мовою, але їм бракувало поштовху, так само, як ще вчора вам!».
`,
      taskTitle: `Завдання`,
...
`,
    },
    {
      ...
      subheader: ``,
      text: `Сьогодні відпочиньте в українському культурному полі та познайомтеся з українським 
      ютубом. Ми підшукали канали, які відкриють вам світ науки, музики, кіно, подорожей та 
      всякого цікавого.
