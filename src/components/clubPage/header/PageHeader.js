...
const PageHeader = ({club}) => {
    ...
    return (
        <Header className="page-header" style={{background: `url(${club.urlBackground == null || club.urlBackground === DEFAULT_BACKGROUND ? process.env.PUBLIC_URL + DEFAULT_BACKGROUND 
